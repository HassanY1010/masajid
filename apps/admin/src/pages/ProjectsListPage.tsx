      ...
      <div className="p-4 rounded-2xl bg-slate-900 border border-slate-800 flex flex-col md:flex-row gap-3 items-stretch md:items-center justify-between">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:flex md:items-center gap-2.5 w-full md:w-auto">
          <select
            ...
            className="w-full md:w-auto bg-slate-950 border border-slate-800 rounded-xl px-3.5 py-2.5 text-sm text-slate-300 focus:outline-none focus:border-brand-500"
          >
          ...
          <select
            ...
            className="w-full md:w-auto bg-slate-950 border border-slate-800 rounded-xl px-3.5 py-2.5 text-sm text-slate-300 focus:outline-none focus:border-brand-500 max-w-full"
          >
